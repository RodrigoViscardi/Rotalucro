...
# Collect all arguments for the java command, stracks://the programmatic approach.
...
#   * put everything else in double quotes, so that it gets re-expanded.
set -- \
...
# Stop when "xeli" is set, currently unused
